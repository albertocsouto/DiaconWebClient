...
function $doShowCalendar(date){
  $clinit_258();
  newItem('list' + $format($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), date), true);
}
...
function $fetchDiaryEntries(this$static, date){
  ...
  date == '' && (date = $format($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), $Date(new Date_0)));
...
function $DiaryViewImpl(this$static){
  ...
  $addDomHandler(this$static.foodTree, $DiaryViewImpl$3(new DiaryViewImpl$3, this$static), ($clinit_163() , $clinit_163() , TYPE_5));
...
function $setDate(this$static, stringDate){
  var date;
  date = $parse($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), stringDate, false);
...
function $getAbsoluteLeft(elem){
  ...
  return $getBoundingClientRectLeft(elem) + $getScrollLeft(($clinit_95() , doc));
}

function $getAbsoluteTop(elem){
  var doc;
  doc = elem.ownerDocument;
  return $getBoundingClientRectTop(elem) + $getScrollTop(($clinit_95() , doc));
}
...
function $clinit_132(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_132() , new ChangeEvent));
}
...
function $clinit_134(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'click', ($clinit_134() , new ClickEvent));
}
...
function $clinit_138(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'focus', ($clinit_138() , new FocusEvent));
}
...
function $clinit_160(){
  ...
  TYPE_4 = $DomEvent$Type(new DomEvent$Type, 'keypress', ($clinit_160() , new KeyPressEvent));
}
...
function $clinit_163(){
  ...
  TYPE_5 = $DomEvent$Type(new DomEvent$Type, 'mouseout', ($clinit_163() , new MouseOutEvent));
}
...
function $clinit_165(){
  ...
  TYPE_6 = $DomEvent$Type(new DomEvent$Type, 'mouseover', ($clinit_165() , new MouseOverEvent));
}
...
function $clinit_167(){
  ...
  TYPE_7 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_167() , new MouseUpEvent));
}
...
function toString_9(){
  ...
  for (i = 0 , c = this.jsArray.length; i < c; ++i) {
    ...
    $append_4(sb, (v = this.jsArray[i] , func = ($clinit_221() , typeMap)[typeof v] , func?func(v):throwUnknownTypeException(typeof v)));
  }
  $append_0(sb.data_0, ']');
  return $toString_3(sb.data_0);
}
...
function toString_10(){
  return $clinit_406() , '' + this.value_0;
}
...
function $clinit_216(){
  ...
  instance_1 = ($clinit_216() , new JSONNull);
}
...
function $get0(this$static, key){
  ...
  var func = ($clinit_221() , typeMap)[typeof v];
...
function onLoad_0(){
  loaded = true;
  instance_2 = ($clinit_235() , new AsyncLoader1);
...
_ = com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator$1.prototype;
...
function $DecoratorPanel_0(this$static, rowStyles, containerIndex){
  ...
  for (i = 0; i < rowStyles.length; ++i) {
    row = (trElem = $createElement($doc, 'tr') , trElem['className'] = rowStyles[i] , $clinit_203() , trElem.appendChild(createTD(rowStyles[i] + 'Left')) , trElem.appendChild(createTD(rowStyles[i] + 'Center')) , trElem.appendChild(createTD(rowStyles[i] + 'Right')) , trElem);
...
function $clinit_308(){
  ...
  ALIGN_DEFAULT = ($clinit_203() , ALIGN_LEFT);
}
...
function $Image$ClippedState(this$static, image, url, left, top_0, width, height){
  var tmp, style_1;
  this$static.width = width;
  $replaceElement_0(image, (tmp = $createElement(($clinit_95() , $doc), 'span') , tmp.innerHTML = (style_1 = 'width: ' + width + 'px; height: ' + height + 'px; background: url(' + url + ') no-repeat ' + -left + 'px ' + -top_0 + 'px' , "<img src='" + $moduleBase + "clear.cache.gif' style='" + style_1 + "' border='0'>") || '' , $getFirstChildElement(tmp)));
...
function $moveFocus(this$static){
  var containerLeft, containerTop, height, left, selectedElem, top_0, width, doc, doc_0;
  ...
  left = (doc = selectedElem.ownerDocument , $getBoundingClientRectLeft(selectedElem) + $getScrollLeft_1($equals_3(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body)) - containerLeft;
  top_0 = (doc_0 = selectedElem.ownerDocument , $getBoundingClientRectTop(selectedElem) + (($equals_3(doc_0.compatMode, 'CSS1Compat')?doc_0.documentElement:doc_0.body).scrollTop || 0)) - containerTop;
...
function $showImage(treeItem, proto){
  ...
  !child?holder.appendChild($createStructure(proto.url, proto.left_0, proto.top_0, proto.width, proto.height)):$adjust(child, proto.url, proto.left_0, proto.top_0, proto.width, proto.height);
}
...
function $createStructure(url, left, top_0, width, height){
  var tmp, style_1;
  tmp = $createElement(($clinit_95() , $doc), 'span');
...
function $CalendarModel(this$static){
  ...
  for (i = 1; i <= 7; ++i) {
    ...
    dayOfWeekNames[dayOfWeek] = $format($DateTimeFormat(new DateTimeFormat, 'ccccc', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), date);
  }
  date.setMonth_0(0);
  for (i = 1; i < 32; ++i) {
    $setDate_0(date, i);
    dayOfMonthNames[i] = $format($DateTimeFormat(new DateTimeFormat, 'd', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), date);
  }
  return this$static;
}

function $formatCurrentMonth(this$static){
  return $format($DateTimeFormat(new DateTimeFormat, 'MMM yyyy', $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0))), this$static.currentMonth);
}
...
function $getCurrentFirstDayOfFirstWeek(this$static){
  ...
  start = ($clinit_365() , $clinit_365() , startingDay);
...
function $clinit_365(){
  ...
  intlConstants = $getDateTimeConstants(($clinit_203() , $clinit_203() , instance_0));
...
function $DatePicker_0(this$static, monthSelector, view, model){
  ...
  this$static.css = ($clinit_374() , DEFAULT);
  ...
  $addDomHandler(monthSelector.backwards, $DefaultMonthSelector$1(new DefaultMonthSelector$1, monthSelector), ($clinit_134() , $clinit_134() , TYPE_2));
...
function $isDateVisible(this$static, date){
  ...
  return !!date && (($clinit_365() , (first.checkJsDate() , first.jsdate.getFullYear() - 1900) == (date.checkJsDate() , date.jsdate.getFullYear() - 1900) && (first.checkJsDate() , first.jsdate.getMonth()) == (date.checkJsDate() , date.jsdate.getMonth()) && (first.checkJsDate() , first.jsdate.getDate()) == (date.checkJsDate() , date.jsdate.getDate())) || (last.checkJsDate() , last.jsdate.getFullYear() - 1900) == (date.checkJsDate() , date.jsdate.getFullYear() - 1900) && (last.checkJsDate() , last.jsdate.getMonth()) == (date.checkJsDate() , date.jsdate.getMonth()) && (last.checkJsDate() , last.jsdate.getDate()) == (date.checkJsDate() , date.jsdate.getDate()) || compare_0(fromDouble((first.checkJsDate() , first.jsdate.getTime())), fromDouble((date.checkJsDate() , date.jsdate.getTime()))) < 0 && compare_0(fromDouble((last.checkJsDate() , last.jsdate.getTime())), fromDouble((date.checkJsDate() , date.jsdate.getTime()))) > 0);
}
...
function $setup_0(this$static){
  ...
  weekendEndColumn = -1;
  for (i = 0; i < 7; ++i) {
    shift = ($clinit_365() , $clinit_365() , startingDay);
    dayIdx = i + shift < 7?i + shift:i + shift - 7;
    $setText_1(this$static.grid, 0, i, ($clinit_364() , dayOfWeekNames)[dayIdx]);
...
function $getTimeTextBox(this$static){
  ...
  if (!this$static.timeTextBox) {
    ...
    $addDomHandler(this$static.timeTextBox, handler, ($clinit_138() , $clinit_138() , TYPE_3));
    $addDomHandler(this$static.timeTextBox, handler, ($clinit_165() , $clinit_165() , TYPE_6));
...
function $getButtonAm(this$static){
  if (!this$static.buttonAm) {
    ...
    $addDomHandler(this$static.buttonAm, this$static.modeListener, ($clinit_165() , $clinit_165() , TYPE_6));
  }
...
function $getButtonPm(this$static){
  if (!this$static.buttonPm) {
    ...
    $addDomHandler(this$static.buttonPm, this$static.modeListener, ($clinit_165() , $clinit_165() , TYPE_6));
  }
...
function $getHourButtons(this$static){
  ...
  if (!this$static.hourButtons[0]) {
    for (i = 0; i < 24; ++i) {
      ...
      $addDomHandler(this$static.hourButtons[i], this$static.hourListener, ($clinit_165() , $clinit_165() , TYPE_6));
      $addDomHandler(this$static.hourButtons[i], this$static.hourListener, ($clinit_167() , $clinit_167() , TYPE_7));
    }
  }
...
function $getMinuteButtons(this$static){
  ...
  if (!this$static.minuteButtons[0]) {
    for (i = 0; i < 4; ++i) {
      ...
      $addDomHandler(this$static.minuteButtons[i], this$static.minuteListener, ($clinit_165() , $clinit_165() , TYPE_6));
      $addDomHandler(this$static.minuteButtons[i], this$static.minuteListener, ($clinit_167() , $clinit_167() , TYPE_7));
    }
  }
...
function $initialize(this$static, model){
  ...
  if (model.hour < 12) {
    $setMode(this$static.state, ($clinit_391() , AM_MODE));
    ...
    $setMode(this$static.state, ($clinit_391() , PM_MODE));
...
function $TimePicker$TimePopupFlexTable$TimePanelState(this$static, this$1){
  this$static.this$1 = this$1;
  this$static.mode = ($clinit_391() , AM_MODE);
  return this$static;
}

function $getAbsoluteHourIndex(this$static){
  if (this$static.mode == ($clinit_391() , PM_MODE)) {
