...
function $doShowCalendar(date){
  $clinit_261();
  newItem('list' + $format($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), date), true);
}
...
function $fetchDiaryEntries(this$static, date){
  ...
  date == '' && (date = $format($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), $Date(new Date_0)));
...
function $onAddButtonClicked(this$static){
  ...
  switch (action.ordinal) {
    case 1:
      this$static.newDiaryEntry = $DiaryEntry(new DiaryEntry, action, this$static.date_0, $getTime(this$static.view), $DiaryDataFood_0(new DiaryDataFood, $getFoodTime(this$static.view), $getInnerText(($clinit_95() , impl), this$static.view.foodTree.curSelection.contentElem), __parseAndValidateDouble($getPropertyString(this$static.view.foodQuantityText.element, 'value'))));
      break;
    case 2:
...
function $DiaryViewImpl(this$static){
  ...
  $addDomHandler(this$static.foodTree, $DiaryViewImpl$3(new DiaryViewImpl$3, this$static), ($clinit_167() , $clinit_167() , TYPE_5));
...
function $onSelectedFood(this$static, event_0){
  if ($getChildCount(event_0.selectedItem) == 0) {
    ...
    $setInnerText_0(this$static.foodChooser.element, $getInnerText(($clinit_95() , impl), event_0.selectedItem.contentElem));
  }
}
...
function $setDate(this$static, stringDate){
  var date;
  date = $parse($DateTimeFormat(new DateTimeFormat, 'yyyyMMdd', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), stringDate, false);
...
function $setInnerText_0(this$static, text){
  $setInnerText(($clinit_95() , this$static), text);
}
...
function flush(which){
  ...
  if (toInjectAtStart.length != 0) {
    ...
    maybeReturn = $injectStyleSheetAtStart(($clinit_131() , IMPL), css);
    toInjectAtStart == which && (toReturn = maybeReturn);
    toInjectAtStart.length = 0;
  }
  if (toInject.length != 0) {
    css = toInject.join('');
    maybeReturn = $injectStyleSheet(($clinit_131() , IMPL), css);
...
function execute_2(){
  ($clinit_129() , needsInjection) && flush(null);
}
...
function $clinit_131(){
  ...
  IMPL = ($clinit_131() , new StyleInjector$StyleInjectorImpl);
}
...
function $clinit_136(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_136() , new ChangeEvent));
}
...
function $clinit_138(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'click', ($clinit_138() , new ClickEvent));
}
...
function $clinit_142(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'focus', ($clinit_142() , new FocusEvent));
}
...
function $clinit_164(){
  ...
  TYPE_4 = $DomEvent$Type(new DomEvent$Type, 'keypress', ($clinit_164() , new KeyPressEvent));
}
...
function $clinit_167(){
  ...
  TYPE_5 = $DomEvent$Type(new DomEvent$Type, 'mouseout', ($clinit_167() , new MouseOutEvent));
}
...
function $clinit_169(){
  ...
  TYPE_6 = $DomEvent$Type(new DomEvent$Type, 'mouseover', ($clinit_169() , new MouseOverEvent));
}
...
function $clinit_171(){
  ...
  TYPE_7 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_171() , new MouseUpEvent));
}
...
function toString_9(){
  ...
  for (i = 0 , c = this.jsArray.length; i < c; ++i) {
    ...
    $append_5(sb, (v = this.jsArray[i] , func = ($clinit_225() , typeMap)[typeof v] , func?func(v):throwUnknownTypeException(typeof v)));
  }
  sb.impl.string += ']';
  return sb.impl.string;
}
...
function toString_10(){
  return $clinit_409() , '' + this.value_0;
}
...
function $clinit_220(){
  ...
  instance_1 = ($clinit_220() , new JSONNull);
}
...
function $get0(this$static, key){
  ...
  var func = ($clinit_225() , typeMap)[typeof v];
...
function onLoad_0(){
  loaded = true;
  instance_2 = ($clinit_239() , new AsyncLoader1);
...
function setTabIndex_0(index){
  ($clinit_296() , this.element).tabIndex = index;
}
...
function $DecoratorPanel_0(this$static, rowStyles, containerIndex){
  ...
  for (i = 0; i < rowStyles.length; ++i) {
    row = (trElem = $doc.createElement('tr') , trElem['className'] = rowStyles[i] , $clinit_207() , trElem.appendChild(createTD(rowStyles[i] + 'Left')) , trElem.appendChild(createTD(rowStyles[i] + 'Center')) , trElem.appendChild(createTD(rowStyles[i] + 'Right')) , trElem);
...
function $setText_0(this$static, row, column, text){
  ...
  text != null && $setInnerText(($clinit_95() , td), text);
}
...
function $clinit_296(){
  ...
  impl_1 = ($clinit_362() , $clinit_362() , implPanel);
}
...
function $clinit_309(){
  ...
  ALIGN_DEFAULT = ($clinit_207() , ALIGN_LEFT);
}
...
function $HorizontalPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_309() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_314() , ALIGN_TOP);
...
function $PopupPanel(this$static){
  ...
  this$static.animType = ($clinit_329() , CENTER);
...
function $setPopupPosition(this$static, left, top_0){
  ...
  elem.style['left'] = left + ($clinit_119() , 'px');
...
function $onResize(){
  ...
  null.nullMethod(0 + ($clinit_119() , 'px'));
  null.nullMethod('0px');
...
function $onInstantaneousRun(this$static){
  ...
  if (this$static.showing) {
    ...
    $add_2(($clinit_333() , get_2(null)), this$static.curPanel);
    $clinit_325();
  }
   else {
    $remove_4(($clinit_333() , get_2(null)), this$static.curPanel);
    $clinit_325();
  }
...
function $onUpdate(this$static, progress){
  ...
  $setClip(($clinit_325() , this$static.curPanel.element), 'rect(' + top_0 + 'px, ' + right + 'px, ' + bottom + 'px, ' + left + 'px)');
}
...
function $setState_0(this$static, showing){
  ...
  $cancel(this$static);
  animate = false;
  this$static.curPanel.animType != ($clinit_329() , CENTER) && !showing && (animate = false);
  this$static.showing = showing;
  if (animate) {
    if (showing) {
      $maybeShowGlass(this$static);
      this$static.curPanel.element.style['position'] = 'absolute';
      this$static.curPanel.topPosition != -1 && $setPopupPosition(this$static.curPanel, this$static.curPanel.leftPosition, this$static.curPanel.topPosition);
      $setClip(($clinit_325() , this$static.curPanel.element), 'rect(0px, 0px, 0px, 0px)');
      $add_2(($clinit_333() , get_2(null)), this$static.curPanel);
    }
...
function onComplete_0(){
  if (!this.showing) {
    $maybeShowGlass(this);
    $remove_4(($clinit_333() , get_2(null)), this.curPanel);
    $clinit_325();
  }
  $setClip(($clinit_325() , this.curPanel.element), 'rect(auto, auto, auto, auto)');
...
function $PushButton(this$static){
  $clinit_332();
  $ButtonBase(this$static, $createFocusable(($clinit_296() , impl_1)));
...
function $init_4(this$static, images, useLeafImages){
  ...
  this$static.focusable = $createFocusable(($clinit_296() , impl_1));
...
function $moveFocus(this$static){
  ...
  ($clinit_296() , this$static.focusable).focus();
}
...
function $setImages(this$static, images, useLeafImages){
  ...
  if (!useLeafImages) {
    ...
    $add_2(($clinit_333() , get_2(null)), image);
...
function doAttachChildren_1(){
  try {
    tryCommand(this, ($clinit_279() , attachCommand));
  }
   finally {
...
function doDetachChildren_1(){
  try {
    tryCommand(this, ($clinit_279() , detachCommand));
  }
   finally {
...
function onBrowserEvent_3(event_0){
  ...
  switch (eventType) {
    case 1:
      {
        e = event_0.target;
        shouldTreeDelegateFocusToElement(e) || !!this.curSelection && (($clinit_296() , this.focusable).focus() , undefined);
        break;
      }
...
function $convertToFullNode(item){
  ...
  if (!item.imageHolder) {
    itemTable = ($clinit_350() , BASE_INTERNAL_ELEM).cloneNode(true);
...
function $adjust(img, url, left, top_0, width, height){
  ...
  img.style['width'] = width + ($clinit_119() , 'px');
...
function $setClip(popup, rect){
  ...
  popup.style['display'] = ($clinit_108() , 'none');
  popup.style['display'] = '';
}
...
function execute_9(){
  this.val$outerElem.style['overflow'] = ($clinit_114() , 'auto');
}
...
function $CalendarModel(this$static){
  ...
  for (i = 1; i <= 7; ++i) {
    ...
    dayOfWeekNames[dayOfWeek] = $format($DateTimeFormat(new DateTimeFormat, 'ccccc', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), date);
  }
  date.setMonth_0(0);
  for (i = 1; i < 32; ++i) {
    $setDate_0(date, i);
    dayOfMonthNames[i] = $format($DateTimeFormat(new DateTimeFormat, 'd', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), date);
  }
  return this$static;
}

function $formatCurrentMonth(this$static){
  return $format($DateTimeFormat(new DateTimeFormat, 'MMM yyyy', $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0))), this$static.currentMonth);
}
...
function $getCurrentFirstDayOfFirstWeek(this$static){
  ...
  start = ($clinit_368() , $clinit_368() , startingDay);
...
function $clinit_368(){
  ...
  intlConstants = $getDateTimeConstants(($clinit_207() , $clinit_207() , instance_0));
...
function $DatePicker_0(this$static, monthSelector, view, model){
  ...
  this$static.css = ($clinit_377() , DEFAULT);
  ...
  $addDomHandler(monthSelector.backwards, $DefaultMonthSelector$1(new DefaultMonthSelector$1, monthSelector), ($clinit_138() , $clinit_138() , TYPE_2));
...
function $isDateVisible(this$static, date){
  ...
  return !!date && (($clinit_368() , (first.checkJsDate() , first.jsdate.getFullYear() - 1900) == (date.checkJsDate() , date.jsdate.getFullYear() - 1900) && (first.checkJsDate() , first.jsdate.getMonth()) == (date.checkJsDate() , date.jsdate.getMonth()) && (first.checkJsDate() , first.jsdate.getDate()) == (date.checkJsDate() , date.jsdate.getDate())) || (last.checkJsDate() , last.jsdate.getFullYear() - 1900) == (date.checkJsDate() , date.jsdate.getFullYear() - 1900) && (last.checkJsDate() , last.jsdate.getMonth()) == (date.checkJsDate() , date.jsdate.getMonth()) && (last.checkJsDate() , last.jsdate.getDate()) == (date.checkJsDate() , date.jsdate.getDate()) || compare_0(fromDouble((first.checkJsDate() , first.jsdate.getTime())), fromDouble((date.checkJsDate() , date.jsdate.getTime()))) < 0 && compare_0(fromDouble((last.checkJsDate() , last.jsdate.getTime())), fromDouble((date.checkJsDate() , date.jsdate.getTime()))) > 0);
}
...
function $setup_0(this$static){
  ...
  weekendEndColumn = -1;
  for (i = 0; i < 7; ++i) {
    shift = ($clinit_368() , $clinit_368() , startingDay);
    dayIdx = i + shift < 7?i + shift:i + shift - 7;
    $setText_0(this$static.grid, 0, i, ($clinit_367() , dayOfWeekNames)[dayIdx]);
...
function $update_0(this$static, current){
  ...
  $setInnerText(($clinit_95() , this$static.element), value);
...
function $getTimeTextBox(this$static){
  ...
  if (!this$static.timeTextBox) {
    ...
    $addDomHandler(this$static.timeTextBox, handler, ($clinit_142() , $clinit_142() , TYPE_3));
    $addDomHandler(this$static.timeTextBox, handler, ($clinit_169() , $clinit_169() , TYPE_6));
...
function $getButtonAm(this$static){
  if (!this$static.buttonAm) {
    ...
    $addDomHandler(this$static.buttonAm, this$static.modeListener, ($clinit_169() , $clinit_169() , TYPE_6));
  }
...
function $getButtonPm(this$static){
  if (!this$static.buttonPm) {
    ...
    $addDomHandler(this$static.buttonPm, this$static.modeListener, ($clinit_169() , $clinit_169() , TYPE_6));
  }
...
function $getHourButtons(this$static){
  ...
  if (!this$static.hourButtons[0]) {
    for (i = 0; i < 24; ++i) {
      ...
      $addDomHandler(this$static.hourButtons[i], this$static.hourListener, ($clinit_169() , $clinit_169() , TYPE_6));
      $addDomHandler(this$static.hourButtons[i], this$static.hourListener, ($clinit_171() , $clinit_171() , TYPE_7));
    }
  }
...
function $getMinuteButtons(this$static){
  ...
  if (!this$static.minuteButtons[0]) {
    for (i = 0; i < 4; ++i) {
      ...
      $addDomHandler(this$static.minuteButtons[i], this$static.minuteListener, ($clinit_169() , $clinit_169() , TYPE_6));
      $addDomHandler(this$static.minuteButtons[i], this$static.minuteListener, ($clinit_171() , $clinit_171() , TYPE_7));
    }
  }
...
function $initialize(this$static, model){
  ...
  if (model.hour < 12) {
    $setMode(this$static.state, ($clinit_394() , AM_MODE));
    ...
    $setMode(this$static.state, ($clinit_394() , PM_MODE));
...
function onMouseOver_3(event_0){
  ...
  text = $getInnerText(($clinit_95() , impl), bt.element);
...
function $TimePicker$TimePopupFlexTable$TimePanelState(this$static, this$1){
  this$static.this$1 = this$1;
  this$static.mode = ($clinit_394() , AM_MODE);
  return this$static;
}

function $getAbsoluteHourIndex(this$static){
  if (this$static.mode == ($clinit_394() , PM_MODE)) {
